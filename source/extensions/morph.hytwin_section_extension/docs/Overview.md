...
- Configuration options are accessible through the extension?셲 settings and integrated menu, enabling users to customize the tool?셲 behavior to match their workflow preferences.
