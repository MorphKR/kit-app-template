...
**morph.hytwin_section_extension2** provides an interactive tool window for managing and manipulating sectional views within the viewport. The extension enables users to create, adjust, and save sectional configurations with intuitive visual controls and custom manipulators. It streamlines section editing by presenting clearly organized panels and interaction tools directly within the Omniverse Kit environment. <!-- #TODO -->

```{image} ../../../../source/extensions/ui/morph.hytwin_section_extension2/data/icons/preview.png <!-- #TODO -->
---
align: center
---
```
