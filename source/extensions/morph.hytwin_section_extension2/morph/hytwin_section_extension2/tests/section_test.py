...
from morph.hytwin_section_extension2 import get_instance as get_section_instance #TODO
from morph.hytwin_section_extension2.common import CURRENT_TOOL_PATH, SETTING_SECTION_ALWAYS_DISPLAY, WINDOW_NAME #TODO
...
class TestSection(OmniUiTest):
    ...
    async def test_general(self):
        from morph.hytwin_section_extension2.common import SectionManager #TODO
...
class TestSectionExtension(OmniUiTest):
    ...
    async def test_extension(self):
        ...
        ext_id = "morph.hytwin_section_extension2" #TODO
