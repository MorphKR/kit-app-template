...
class SectionToolExtension(omni.ext.IExt, MenuHelperExtension):
    ...
    SETTING_MENU_PATH = "/exts/morph.hytwin_section_extension2/menuPath" #TODO
...
def get_instance() -> SectionToolExtension:
    #TODO renamed extension id reference
    """Return the singleton instance of SectionToolExtension for extension morph.hytwin_section_extension2.
